...
const config: Config = {
  ...
  markdown: {
    mermaid: true,
    // .md files are parsed as plain Markdown; only .mdx files use MDX. The
    // autogenerated API reference under docs/references/api/ contains code
    // examples with `{`, `<`, `|` which the MDX JSX parser would choke on.
    format: 'detect',
  },
