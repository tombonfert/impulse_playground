---
sidebar_label: sequence_of_events
title: impulse_reporting.events.sequence_of_events
---
...
- `max_overlap` (`float`): Maximum allowed overlap time between consecutive events.
