...
def test_report_rejects_two_container_events():
    ...
    DUMMY_CONFIG = {
        "source": {
            "container_metrics_table": "spark_catalog.silver.container_metric",
            "channel_metrics_table": "spark_catalog.silver.channel_metric",
            "channels_uri": "spark_catalog.silver.channel_data",
        },
        "unity_sink": {
